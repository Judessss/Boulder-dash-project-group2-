...
public class SpriteTest {
	 ...
	 * It is used to release the allocation that the BeforeClass method allocates. It runs even if the BeforeClass method throws an exception.
	 * 
	 * @throws Exception Every Exception
	 */
	@AfterClass
	 ...
	 * It is used to release the allocation that the Before method allocates. It runs even if the Before method throws an exception.
	 * 
	 * @throws Exception Every Exception
	 */
	@After
